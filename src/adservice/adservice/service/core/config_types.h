...
struct DBConfig {
    std::string accessUrl{ "tcp://rm-2zek1ct2g06ergoum.mysql.rds.aliyuncs.com:3306" };
    std::string dbName{ "mtdb" };
    std::string userName{ "mtty_root" };
    std::string password{ "Mtkj*8888" };
};

struct URLConfig {
    std::string sslShowUrl{ "https://show.mtty.com/s" };
    std::string nonSSLShowUrl{ "http://show.mtty.com/s" };
    std::string sslClickUrl{ "https://click.mtty.com/c" };
    std::string nonSSLClickUrl{ "http://click.mtty.com/c" };
};
