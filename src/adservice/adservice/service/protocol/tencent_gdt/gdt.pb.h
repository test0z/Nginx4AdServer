...
class BidRequest_Impression_Native : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:protocol.gdt.adx.BidRequest.Impression.Native) */ {
 public:
  ...
  inline BidRequest_Impression_Native* New() const { return New(NULL); }

  BidRequest_Impression_Native* New(::google::protobuf::Arena* arena) const;
  ...
  void InternalSwap(BidRequest_Impression_Native* other);
  private:
  ...
  static const Fields kHeadline =
    BidRequest_Impression_Native_Fields_kHeadline;
  static const Fields kIcon =
    BidRequest_Impression_Native_Fields_kIcon;
  static const Fields kImage =
    BidRequest_Impression_Native_Fields_kImage;
  static const Fields kDescription =
    BidRequest_Impression_Native_Fields_kDescription;
  ...
  static const Type kLink =
    BidRequest_Impression_Native_Type_kLink;
  static const Type kApp =
    BidRequest_Impression_Native_Type_kApp;
  ...
  ::google::protobuf::uint64 required_fields() const;
  void set_required_fields(::google::protobuf::uint64 value);

  // optional .protocol.gdt.adx.BidRequest.Impression.Native.Type type = 2;
  bool has_type() const;
  void clear_type();
  static const int kTypeFieldNumber = 2;
  ::protocol::gdt::adx::BidRequest_Impression_Native_Type type() const;
  void set_type(::protocol::gdt::adx::BidRequest_Impression_Native_Type value);
...
class BidRequest_Impression : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:protocol.gdt.adx.BidRequest.Impression) */ {
 public:
  ...
  inline BidRequest_Impression* New() const { return New(NULL); }

  BidRequest_Impression* New(::google::protobuf::Arena* arena) const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  ...
  void SharedDtor();
  void SetCachedSize(int size) const;
  void InternalSwap(BidRequest_Impression* other);
  private:
  inline ::google::protobuf::Arena* GetArenaNoVirtual() const {
    return _internal_metadata_.arena();
  }
  ...
  bool has_placement_id() const;
  void clear_placement_id();
  static const int kPlacementIdFieldNumber = 2;
  ::google::protobuf::int64 placement_id() const;
  void set_placement_id(::google::protobuf::int64 value);

  // repeated int32 creative_specs = 3;
  int creative_specs_size() const;
  void clear_creative_specs();
  static const int kCreativeSpecsFieldNumber = 3;
  ::google::protobuf::int32 creative_specs(int index) const;
  void set_creative_specs(int index, ::google::protobuf::int32 value);
  void add_creative_specs(::google::protobuf::int32 value);
  ...
  bool has_bid_floor() const;
  void clear_bid_floor();
  static const int kBidFloorFieldNumber = 4;
  ::google::protobuf::int32 bid_floor() const;
  void set_bid_floor(::google::protobuf::int32 value);

  // repeated int64 blocking_industry_id = 5;
  int blocking_industry_id_size() const;
  void clear_blocking_industry_id();
  static const int kBlockingIndustryIdFieldNumber = 5;
  ::google::protobuf::int64 blocking_industry_id(int index) const;
  void set_blocking_industry_id(int index, ::google::protobuf::int64 value);
  void add_blocking_industry_id(::google::protobuf::int64 value);
  ...
  int natives_size() const;
  void clear_natives();
  static const int kNativesFieldNumber = 6;
  const ::protocol::gdt::adx::BidRequest_Impression_Native& natives(int index) const;
  ::protocol::gdt::adx::BidRequest_Impression_Native* mutable_natives(int index);
  ::protocol::gdt::adx::BidRequest_Impression_Native* add_natives();
...
class BidRequest_Device : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:protocol.gdt.adx.BidRequest.Device) */ {
 public:
  BidRequest_Device();
  ...
  ::protocol::gdt::adx::BidRequest_DeviceType device_type() const;
  void set_device_type(::protocol::gdt::adx::BidRequest_DeviceType value);

  // optional .protocol.gdt.adx.BidRequest.OperatingSystem os = 3;
  bool has_os() const;
  void clear_os();
  static const int kOsFieldNumber = 3;
  ::protocol::gdt::adx::BidRequest_OperatingSystem os() const;
  void set_os(::protocol::gdt::adx::BidRequest_OperatingSystem value);
  ...
  ::protocol::gdt::adx::BidRequest_Carrier carrier() const;
  void set_carrier(::protocol::gdt::adx::BidRequest_Carrier value);
  ...
  ::protocol::gdt::adx::BidRequest_ConnectionType connection_type() const;
  void set_connection_type(::protocol::gdt::adx::BidRequest_ConnectionType value);

  // optional string brand_and_model = 11;
  bool has_brand_and_model() const;
  void clear_brand_and_model();
  static const int kBrandAndModelFieldNumber = 11;
  const ::std::string& brand_and_model() const;
  void set_brand_and_model(const ::std::string& value);
  void set_brand_and_model(const char* value);
  void set_brand_and_model(const char* value, size_t size);
  ::std::string* mutable_brand_and_model();
  ::std::string* release_brand_and_model();
  void set_allocated_brand_and_model(::std::string* brand_and_model);
 ...
 private:
  ...
  int carrier_;
  ::google::protobuf::internal::ArenaStringPtr brand_and_model_;
...
class BidRequest_User_Demographic : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:protocol.gdt.adx.BidRequest.User.Demographic) */ {
 public:
  ...
  inline BidRequest_User_Demographic* New() const { return New(NULL); }

  BidRequest_User_Demographic* New(::google::protobuf::Arena* arena) const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  ...
  void SharedDtor();
  void SetCachedSize(int size) const;
  void InternalSwap(BidRequest_User_Demographic* other);
  private:
  inline ::google::protobuf::Arena* GetArenaNoVirtual() const {
    return _internal_metadata_.arena();
  }
  ...
  static const Gender GENDER_UNKNOWN =
    BidRequest_User_Demographic_Gender_GENDER_UNKNOWN;
  static const Gender GENDER_MALE =
    BidRequest_User_Demographic_Gender_GENDER_MALE;
  static const Gender GENDER_FEMALE =
    BidRequest_User_Demographic_Gender_GENDER_FEMALE;
  ...
  static const Education EDUCATION_UNKNOWN =
    BidRequest_User_Demographic_Education_EDUCATION_UNKNOWN;
  static const Education EDUCATION_DOCTOR =
    BidRequest_User_Demographic_Education_EDUCATION_DOCTOR;
  static const Education EDUCATION_MASTER =
    BidRequest_User_Demographic_Education_EDUCATION_MASTER;
  static const Education EDUCATION_COLLEGE =
    BidRequest_User_Demographic_Education_EDUCATION_COLLEGE;
  static const Education EDUCATION_HIGH_SCHOOL =
    BidRequest_User_Demographic_Education_EDUCATION_HIGH_SCHOOL;
  static const Education EDUCATION_MIDDLE_SCHOOL =
    BidRequest_User_Demographic_Education_EDUCATION_MIDDLE_SCHOOL;
  static const Education EDUCATION_PRIMARY_SCHOOL =
    BidRequest_User_Demographic_Education_EDUCATION_PRIMARY_SCHOOL;
  ...
  ::protocol::gdt::adx::BidRequest_User_Demographic_Gender gender() const;
  void set_gender(::protocol::gdt::adx::BidRequest_User_Demographic_Gender value);
  ...
  ::protocol::gdt::adx::BidRequest_User_Demographic_Education education() const;
  void set_education(::protocol::gdt::adx::BidRequest_User_Demographic_Education value);

  // optional int32 age_low = 3 [default = 0];
  bool has_age_low() const;
  void clear_age_low();
  static const int kAgeLowFieldNumber = 3;
  ::google::protobuf::int32 age_low() const;
  void set_age_low(::google::protobuf::int32 value);

  // optional int32 age_high = 4 [default = 999];
  bool has_age_high() const;
  void clear_age_high();
  static const int kAgeHighFieldNumber = 4;
  ::google::protobuf::int32 age_high() const;
  void set_age_high(::google::protobuf::int32 value);
...
class BidRequest_User_Vertical : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:protocol.gdt.adx.BidRequest.User.Vertical) */ {
 public:
  ...
  inline BidRequest_User_Vertical* New() const { return New(NULL); }

  BidRequest_User_Vertical* New(::google::protobuf::Arena* arena) const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  ...
  void SharedDtor();
  void SetCachedSize(int size) const;
  void InternalSwap(BidRequest_User_Vertical* other);
  private:
  inline ::google::protobuf::Arena* GetArenaNoVirtual() const {
    return _internal_metadata_.arena();
  }
...
class BidRequest_User : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:protocol.gdt.adx.BidRequest.User) */ {
 public:
  BidRequest_User();
  ...
  bool has_user_demographic() const;
  void clear_user_demographic();
  static const int kUserDemographicFieldNumber = 2;
  const ::protocol::gdt::adx::BidRequest_User_Demographic& user_demographic() const;
  ::protocol::gdt::adx::BidRequest_User_Demographic* mutable_user_demographic();
  ::protocol::gdt::adx::BidRequest_User_Demographic* release_user_demographic();
  void set_allocated_user_demographic(::protocol::gdt::adx::BidRequest_User_Demographic* user_demographic);

  // repeated .protocol.gdt.adx.BidRequest.User.Vertical verticals = 3;
  int verticals_size() const;
  void clear_verticals();
  static const int kVerticalsFieldNumber = 3;
  const ::protocol::gdt::adx::BidRequest_User_Vertical& verticals(int index) const;
  ::protocol::gdt::adx::BidRequest_User_Vertical* mutable_verticals(int index);
  ::protocol::gdt::adx::BidRequest_User_Vertical* add_verticals();
...
class BidRequest_Geo : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:protocol.gdt.adx.BidRequest.Geo) */ {
 public:
  BidRequest_Geo();
...
class BidRequest_App : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:protocol.gdt.adx.BidRequest.App) */ {
 public:
  BidRequest_App();
  ...
  bool has_industry_id() const;
  void clear_industry_id();
  static const int kIndustryIdFieldNumber = 1;
  ::google::protobuf::int64 industry_id() const;
  void set_industry_id(::google::protobuf::int64 value);
...
class BidRequest : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:protocol.gdt.adx.BidRequest) */ {
 public:
  BidRequest();
  virtual ~BidRequest();
  ...
  static const DeviceType kDeviceTypeUnknown =
    BidRequest_DeviceType_kDeviceTypeUnknown;
  static const DeviceType kDeviceTypePC =
    BidRequest_DeviceType_kDeviceTypePC;
  static const DeviceType kDeviceTypeMobile =
    BidRequest_DeviceType_kDeviceTypeMobile;
  static const DeviceType kDeviceTypePad =
    BidRequest_DeviceType_kDeviceTypePad;
  ...
  static const Carrier kCarrierUnknown =
    BidRequest_Carrier_kCarrierUnknown;
  static const Carrier kCarrierChinaMobile =
    BidRequest_Carrier_kCarrierChinaMobile;
  static const Carrier kCarrierChinaUnicom =
    BidRequest_Carrier_kCarrierChinaUnicom;
  static const Carrier kCarrierChinaTelecom =
    BidRequest_Carrier_kCarrierChinaTelecom;
  ...
  static const ConnectionType kConnTypeUnknown =
    BidRequest_ConnectionType_kConnTypeUnknown;
  static const ConnectionType kConnTypeWifi =
    BidRequest_ConnectionType_kConnTypeWifi;
  static const ConnectionType kConnType2G =
    BidRequest_ConnectionType_kConnType2G;
  static const ConnectionType kConnType3G =
    BidRequest_ConnectionType_kConnType3G;
  static const ConnectionType kConnType4G =
    BidRequest_ConnectionType_kConnType4G;
  ...
  static const OperatingSystem kOSUnknown =
    BidRequest_OperatingSystem_kOSUnknown;
  static const OperatingSystem kOSIOS =
    BidRequest_OperatingSystem_kOSIOS;
  static const OperatingSystem kOSAndroid =
    BidRequest_OperatingSystem_kOSAndroid;
  static const OperatingSystem kOSWindows =
    BidRequest_OperatingSystem_kOSWindows;
  static const OperatingSystem kOSSymbian =
    BidRequest_OperatingSystem_kOSSymbian;
  static const OperatingSystem kOSJava =
    BidRequest_OperatingSystem_kOSJava;
  ...
  const ::protocol::gdt::adx::BidRequest_Impression& impressions(int index) const;
  ::protocol::gdt::adx::BidRequest_Impression* mutable_impressions(int index);
  ::protocol::gdt::adx::BidRequest_Impression* add_impressions();
  ...
  const ::protocol::gdt::adx::BidRequest_Device& device() const;
  ::protocol::gdt::adx::BidRequest_Device* mutable_device();
  ::protocol::gdt::adx::BidRequest_Device* release_device();
  void set_allocated_device(::protocol::gdt::adx::BidRequest_Device* device);
  ...
  const ::protocol::gdt::adx::BidRequest_User& user() const;
  ::protocol::gdt::adx::BidRequest_User* mutable_user();
  ::protocol::gdt::adx::BidRequest_User* release_user();
  void set_allocated_user(::protocol::gdt::adx::BidRequest_User* user);

  // optional .protocol.gdt.adx.BidRequest.Geo geo = 9;
  bool has_geo() const;
  void clear_geo();
  static const int kGeoFieldNumber = 9;
  const ::protocol::gdt::adx::BidRequest_Geo& geo() const;
  ::protocol::gdt::adx::BidRequest_Geo* mutable_geo();
  ::protocol::gdt::adx::BidRequest_Geo* release_geo();
  void set_allocated_geo(::protocol::gdt::adx::BidRequest_Geo* geo);

  // optional .protocol.gdt.adx.BidRequest.App app = 10;
  bool has_app() const;
  void clear_app();
  static const int kAppFieldNumber = 10;
  const ::protocol::gdt::adx::BidRequest_App& app() const;
  ::protocol::gdt::adx::BidRequest_App* mutable_app();
  ::protocol::gdt::adx::BidRequest_App* release_app();
  void set_allocated_app(::protocol::gdt::adx::BidRequest_App* app);

  // optional uint64 boss_qq = 11;
  bool has_boss_qq() const;
  void clear_boss_qq();
  static const int kBossQqFieldNumber = 11;
  ::google::protobuf::uint64 boss_qq() const;
  void set_boss_qq(::google::protobuf::uint64 value);
...
class BidResponse_Bid : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:protocol.gdt.adx.BidResponse.Bid) */ {
 public:
  BidResponse_Bid();
  ...
  inline BidResponse_Bid* New() const { return New(NULL); }

  BidResponse_Bid* New(::google::protobuf::Arena* arena) const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  ...
  void SharedDtor();
  void SetCachedSize(int size) const;
  void InternalSwap(BidResponse_Bid* other);
  private:
  inline ::google::protobuf::Arena* GetArenaNoVirtual() const {
    return _internal_metadata_.arena();
  }
  ...
  bool has_bid_price() const;
  void clear_bid_price();
  static const int kBidPriceFieldNumber = 2;
  ::google::protobuf::int32 bid_price() const;
  void set_bid_price(::google::protobuf::int32 value);

  // optional string impression_param = 3;
  bool has_impression_param() const;
  void clear_impression_param();
  static const int kImpressionParamFieldNumber = 3;
  const ::std::string& impression_param() const;
  void set_impression_param(const ::std::string& value);
  void set_impression_param(const char* value);
  void set_impression_param(const char* value, size_t size);
  ::std::string* mutable_impression_param();
  ::std::string* release_impression_param();
  void set_allocated_impression_param(::std::string* impression_param);

  // optional string click_param = 4;
  bool has_click_param() const;
  void clear_click_param();
  static const int kClickParamFieldNumber = 4;
  const ::std::string& click_param() const;
  void set_click_param(const ::std::string& value);
  void set_click_param(const char* value);
  void set_click_param(const char* value, size_t size);
  ::std::string* mutable_click_param();
  ::std::string* release_click_param();
  void set_allocated_click_param(::std::string* click_param);
 ...
 private:
  ...
  ::google::protobuf::internal::ArenaStringPtr impression_param_;
  ::google::protobuf::internal::ArenaStringPtr click_param_;
...
class BidResponse_SeatBid : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:protocol.gdt.adx.BidResponse.SeatBid) */ {
 public:
  BidResponse_SeatBid();
  ...
  const ::protocol::gdt::adx::BidResponse_Bid& bids(int index) const;
  ::protocol::gdt::adx::BidResponse_Bid* mutable_bids(int index);
  ::protocol::gdt::adx::BidResponse_Bid* add_bids();
 ...
 private:
  ...
  ::google::protobuf::uint32 _has_bits_[1];
  mutable int _cached_size_;
  ::google::protobuf::internal::ArenaStringPtr impression_id_;
...
class BidResponse : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:protocol.gdt.adx.BidResponse) */ {
 public:
  BidResponse();
  virtual ~BidResponse();
  ...
  const ::protocol::gdt::adx::BidResponse_SeatBid& seat_bids(int index) const;
  ::protocol::gdt::adx::BidResponse_SeatBid* mutable_seat_bids(int index);
  ::protocol::gdt::adx::BidResponse_SeatBid* add_seat_bids();
...
template <> struct is_proto_enum< ::protocol::gdt::adx::BidRequest_Impression_Native_Fields> : ::google::protobuf::internal::true_type {};
template <>
...
template <> struct is_proto_enum< ::protocol::gdt::adx::BidRequest_Impression_Native_Type> : ::google::protobuf::internal::true_type {};
template <>
...
template <> struct is_proto_enum< ::protocol::gdt::adx::BidRequest_User_Demographic_Gender> : ::google::protobuf::internal::true_type {};
template <>
...
template <> struct is_proto_enum< ::protocol::gdt::adx::BidRequest_User_Demographic_Education> : ::google::protobuf::internal::true_type {};
template <>
...
template <> struct is_proto_enum< ::protocol::gdt::adx::BidRequest_DeviceType> : ::google::protobuf::internal::true_type {};
template <>
...
template <> struct is_proto_enum< ::protocol::gdt::adx::BidRequest_Carrier> : ::google::protobuf::internal::true_type {};
template <>
...
template <> struct is_proto_enum< ::protocol::gdt::adx::BidRequest_ConnectionType> : ::google::protobuf::internal::true_type {};
template <>
...
template <> struct is_proto_enum< ::protocol::gdt::adx::BidRequest_OperatingSystem> : ::google::protobuf::internal::true_type {};
template <>
