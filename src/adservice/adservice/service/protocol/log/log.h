...
#ifndef LOG_AVRO_LOG_H_1469896960__H_
#define LOG_AVRO_LOG_H_1469896960__H_
...
struct AdInfo {
    ...
    std::vector<double > feeRateDetail;
    AdInfo() :
        areaId(std::string()),
        advId(int64_t()),
        cpid(int64_t()),
        ...
        feeRateDetail(std::vector<double >())
        { }
};
...
inline
DeviceInfo __tmp_json_Union__0__::get_DeviceInfo() const {
    if (idx_ != 6) {
        throw avro::Exception("Invalid type for union");
    }
...
inline
void __tmp_json_Union__0__::set_DeviceInfo(const DeviceInfo& v) {
    idx_ = 6;
    value_ = v;
}
...
template<> struct codec_traits<protocol::log::DeviceInfo> {
    static void encode(Encoder& e, const protocol::log::DeviceInfo& v) {
        avro::encode(e, v.flowType);
        avro::encode(e, v.deviceType);
        avro::encode(e, v.netWork);
        avro::encode(e, v.os);
        avro::encode(e, v.deviceID);
        avro::encode(e, v.make);
    }
    static void decode(Decoder& d, protocol::log::DeviceInfo& v) {
        if (avro::ResolvingDecoder *rd =
            dynamic_cast<avro::ResolvingDecoder *>(&d)) {
            const std::vector<size_t> fo = rd->fieldOrder();
            for (std::vector<size_t>::const_iterator it = fo.begin();
                ...
                switch (*it) {
                case 0:
                    avro::decode(d, v.flowType);
                    break;
                case 1:
                    avro::decode(d, v.deviceType);
                    break;
                case 2:
                    avro::decode(d, v.netWork);
                    break;
                case 3:
                    avro::decode(d, v.os);
                    break;
                case 4:
                    avro::decode(d, v.deviceID);
                    break;
                case 5:
                    avro::decode(d, v.make);
                    break;
                default:
                    break;
                }
...
template<> struct codec_traits<protocol::log::LogItem> {
    static void encode(Encoder& e, const protocol::log::LogItem& v) {
        ...
        avro::encode(e, v.dealIds);
        avro::encode(e, v.keyWords);
        ...
        if (avro::ResolvingDecoder *rd =
            ...
            for (std::vector<size_t>::const_iterator it = fo.begin();
                ...
                case 19:
                    ...
                    break;
                case 20:
                    avro::decode(d, v.dealIds);
                    break;
                case 21:
                    avro::decode(d, v.keyWords);
                    break;
                case 22:
