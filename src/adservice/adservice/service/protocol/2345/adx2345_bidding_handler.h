...
#ifndef ADCORE_2345_BIDDING_HANDLER_H
#define ADCORE_2345_BIDDING_HANDLER_H
...
namespace bidding {
     ...
     */
    class Adx2345BiddingHandler : public AbstractBiddingHandler {
    public:
        Adx2345BiddingHandler()
        {
        }
        /**
...
#endif // ADCORE_2345_BIDDING_HANDLER_H
